...
(9, 'Test', 1, 'Test', '2020-06-04', NULL, 'Administrateur'),
(10, 'Regles', 2, 'Si votre post sur ce forum ne respecte pas les règles suivantes, il sera supprimer dans des brefs délais par un administrateur. Merci de lire la totalité des règles :\r\n- poser des questions uniquement dans la catégorie \"Poser une question\" et non dans \"Discussion générale\"', '2020-06-04', NULL, 'Administrateur'),
(11, 'Titre', 0, 'Contenu', '2020-06-04', NULL, 'Administrateur'),
(12, 'Titre', 3, 'Contenu', '2020-06-04', NULL, 'Administrateur');
...
(5, '$2y$10$t8ufEwTWpzLSG1QiSNEeH.r1.k6UiY9v8YQF1IgI.b.yHzLm5EnXG', 'test-auto', '1 rue de la république', 'test-auto@isep.fr'),
(6, '$2y$10$3UsLPb46piJ9astPyWGQAOKCvliVT.q4uWRd3mHxyUHoUj8.a6M4m', 'Meudon', '1 rue de meudon', 'meudon@isep.fr');
...
(21, 9, 'test', 'Administrateur', '2020-06-04 17:06:05');
