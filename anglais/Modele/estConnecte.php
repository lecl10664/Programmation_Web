...
try {
    $bdd = new PDO('mysql:host=localhost;dbname=id13853313_appg9b;charset=utf8', 'id13853313_user', 'Passwordpassword0!');
}
catch (Exception $e) {
...
// Comparaison du pass envoyé via le formulaire avec la base
    ...
    if (password_verify($_POST['mdpConnexion'], $donneesUtilisateur['Mot_de_passe'])) {
        ...
        header("location: ..anglais/Controleur/se_connecter_avec_mdp_incorrect2.php");
    }
...
// Comparaison du pass envoyé via le formulaire avec la base
    ...
    if (password_verify($_POST['mdpConnexion'], $donneesGestionnaire['Mot_de_passe'])) {
        header("location: ..anglais/Controleur/gestionnaire2.php");
        session_start();
...
// Comparaison du pass envoyé via le formulaire avec la base
    ...
    if ($_POST['mdpConnexion'] == $donneesAdmin['Mot_de_passe']) {
        header("location: ..anglais/Controleur/pageAdministrateur2.php");
        session_start();
