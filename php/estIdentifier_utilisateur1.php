...
if (isset($_POST['mail'])) {
 ...
 WHERE `Adresse_email` = :Adresse_email ');
    ...
    if ($donnees['Adresse_email'] == $_POST['mail']) {  // Vérifie si l'utilisateur existe deja
        echo '<p>- Adresse email déjà existante, <a href="s_identifier_utilisateur1.php">veuillez réessayer</a><br></p>';
    } else {
...
VALUES (:Mot_de_passe, :Nom, :Prenom, :Date_de_naissance, :Telephone, :Adresse, :Adresse_email)');
        ...
        <div class="inscrit">
            ...
            <p><strong>注册信息</strong> <br>
                邮件 : <?php echo $_POST['mail']; ?> <br>
                <br>
                您已可以登录平台 !
                <br>
            <p><strong><a href="../php/se_connecter1.php">登录 !</a></strong></p>
            </p>
        </div>
        <?php
