...
<div id="conteneur1">
    <div id="menu">
        ...
        <a href="mesDonneesUtilisateurs.php">我的成绩</a>
        <a href="utilisateur_graphes_resultats.php">我的图表</a>
        <a href="utilisateur_rdv.php">我的预约</a>
        <a href="contact.php">联系我</a>
    </div>
    ...
    <div id="profil">
        ...
        <div class="profil-colonnes">
            <div class="profil-texte">
                ...
                <p>邮件 : <?php echo $donneesProfil['Adresse_email']?></p>
...
<div class="graphes">
    ...
    <div class="bouton_graphe">
        <a href="utilisateur_graphes_score_total.php"><button class="button" >总分</button></a>
        <a href="utilisateur_graphes_resultats.php"><button class="button">测试图标</button></a>
    </div>
