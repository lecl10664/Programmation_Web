...
<div id="conteneur1">
    <div id="menu">
        ...
        <a href="gestionnaire.php">开始一项测试</a>
        <a href="gestionnaire_ajout_resultats_tests.php">新的测试结果</a>
        <a href="gestionnaire_rechercheUtilisateur.php">显示用户</a>
        <a href="gestionnaire_rechercheTests.php">显示测试</a>
    </div>
