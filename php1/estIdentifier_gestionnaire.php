...
VALUES (:Mot_de_passe, :Nom, :Adresse, :Adresse_email)');
        ...
        ?>
        <div class="inscrit">
            <p>您的驾校 <strong><?php echo $_POST['nom_auto_ecole']?></strong>已经注册</p>
            <p><strong>您的信息 :</strong>  <br>
                驾校地址 : <?php echo $_POST['adresse_auto_ecole']; ?><br>
                邮件 : <?php echo $_POST['mail_auto_ecole']; ?> <br>
                <br>
                您现在可以登陆我们的平台!
                <br>
            </p>
