...
<div class="box1">
    <form action="estIdentifier_gestionnaire1.php" method="post">
        ...
        <br>
        <input type="checkbox" name="cgu" required/><label>我同意我了解 <a href="cgu1.php">用户协议</a> Infinites Measures</label>
        <br/>
